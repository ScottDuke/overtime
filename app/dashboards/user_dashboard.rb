...
class UserDashboard < Administrate::BaseDashboard
  ...
  ATTRIBUTE_TYPES = {
    ...
    first_name: Field::String.with_options(searchable: true, searchable_field: 'first_name'),
    last_name: Field::String.with_options(searchable: true, searchable_field: 'last_name'),
